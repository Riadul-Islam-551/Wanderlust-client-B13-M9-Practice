...
const AddDestinationPage = () => {
  ...
  return (
    <div>
      <h1 className="font-bold text-2xl md:text-3xl lg:text-5xl mt-9 text-center">Add New Travel Package</h1>
      <Form
    ...
    >
      <div>
        ...
        <TextField isRequired name="DestinationName" type="Text">
          ...
          <Input placeholder="Bali Paradise" className="w-full  border-none shadow-none bg-base-300" />
          <FieldError />
        </TextField>
      </div>
      <div className="flex flex-col lg:flex-row justify-around items-center gap-9">
        ...
        <TextField isRequired name="Country" type="Text" className="w-full">
          <Label>Country </Label>
          <Input placeholder="Indonesia" className="w-full border-none shadow-none bg-base-300" />
          <FieldError />
        </TextField>
        {/* category */}
      ...
      <div className="flex flex-col lg:flex-row justify-around items-center gap-9">
        ...
        <TextField isRequired name="Price" type="Text" className="w-full">
          <Label>Price </Label>
          <Input placeholder="e.g., $1200" className="w-full border-none shadow-none bg-base-300" />
          <FieldError />
        </TextField>
        {/* Duration */}
        <TextField isRequired name="Duration" type="Text" className="w-full">
          <Label>Duration</Label>
          <Input placeholder="e.g., 7 Days/6 Nights" className="w-full border-none shadow-none bg-base-300" />
          <FieldError />
        </TextField>
      </div>
      <div>
        ...
        <TextField isRequired name="DepartureDate" type="text">
          ...
          <Input placeholder="mm/dd/yyyy" className="w-full border-none shadow-none bg-base-300" />
          <FieldError />
        </TextField>
      </div>
      <div>
      ...
      <div>
        ...
        <TextField isRequired className="w-full" name="Description">
          ...
          <TextArea placeholder="Write your message here..." rows={4} className="border-none shadow-none bg-base-300"/>
